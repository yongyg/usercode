...
ecalRecHit = cms.EDProducer("EcalRecHitProducer",
    ...
    testNewInterCalibEB  = cms.untracked.bool(True),
   pathInterCalibFile = cms.untracked.string("AbsolutePath/interCalibConstants.combinedPi0Eta.run160404to180252.EcalBarrel.txt"),
    testNewInterCalibEE  = cms.untracked.bool(True),                            
    pathInterCalibFileEE = cms.untracked.string("AbsolutePath/interCalibConstants.combinedPi0Eta.run160404to180252.EcalEndcap.txt"),
