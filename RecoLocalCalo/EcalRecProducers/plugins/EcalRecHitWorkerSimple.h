...
class EcalRecHitWorkerSimple : public EcalRecHitWorkerBaseClass {
		...
		float interCalibBarrel[170][360];
		bool testNewInterCalibEB_; 
		std::string pathInterCalibFile_;
		
		
		float interCalibEndcap[2][101][101];
		bool testNewInterCalibEE_; 
		std::string pathInterCalibFileEE_;
