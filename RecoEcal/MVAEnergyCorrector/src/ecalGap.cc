...
void loadecalGapCoordinates(){
  ...
  if(isRealData){
    feg->Add("RecoEcal/MVAEnergyCorrector/data/ecalGap.cmssw425.GeometryDB.FT_R_42_V17A.root");///data 
  }else{
    feg->Add("RecoEcal/MVAEnergyCorrector/data/ecalGap.cmssw425.GeometryDB.START42_V12.root"); //MC
  }
